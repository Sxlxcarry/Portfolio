...
export default function LiveConsole() {
  ...
  return (
    <div
      className="relative rounded-3xl overflow-hidden border border-line bg-gradient-to-b from-[rgba(14,19,30,0.85)] to-[rgba(7,10,17,0.85)] backdrop-blur-md shadow-[0_24px_60px_rgba(0,0,0,0.5),inset_0_1px_0_rgba(255,255,255,0.04)]"
