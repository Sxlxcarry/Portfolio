...
export const WORK = {
  fr: {
    ...
    desc: "Études de cas livrées pendant le cursus et l'alternance. Chaque module ouvre un dossier technique au format PDF.",
    filters: [
      { id: '*',             label: 'Tous' },
    ...
    projects: [
      ...
      },
      {
        ...
        href: '/pdfs/rt-bank-multisite.pdf',
      },
      {
        id: 'multi-vlan-lab',
        index: '/03',
      ...
      },
      {
        ...
        type: ['security', 'observability', 'devops'],
        title: 'Agent de veille cybersécurité',
        summary: 'Bot Python autonome (stage) : interrogation de 5 API de vulnérabilités (NVD, CISA KEV, CERT-FR, GHSA, endoflife.date), scan Trivy et alertes Slack automatisées.',
        stack: ['Python', 'Docker', 'Trivy', 'Slack'],
        href: '/pdfs/veille-cyber.pdf',
      },
    ] as Project[],
  },
  en: {
    ...
    projects: [
      ...
      },
      {
        ...
        type: ['security', 'observability', 'devops'],
        title: 'Cybersecurity watch agent',
        summary: 'Autonomous Python bot (internship): polls 5 vulnerability APIs (NVD, CISA KEV, CERT-FR, GHSA, endoflife.date), runs Trivy scans and sends automated Slack alerts.',
        stack: ['Python', 'Docker', 'Trivy', 'Slack'],
        href: '/pdfs/veille-cyber.pdf',
      },
    ] as Project[],
  ...
  fr: {
    ...
    items: [
      ...
      },
      {
        ...
        index: '/R02',
        kind: 'Blue Team',
        title: 'Veille CVE · Agent autonome',
        summary:
          "Conçu et développé en totale autonomie durant un stage, sans accompagnement technique de l'entreprise sur ce sujet : architecture, matching CVE, priorisation, sécurisation du bot lui-même. Code généré avec l'assistance de Claude (IA), piloté et validé par moi-même.",
        stack: ['Python', 'API CVE', 'Trivy', 'Autoformation'],
        status: 'Livré',
        href: '/pdfs/veille-cyber.pdf',
      },
      {
  ...
  en: {
    ...
    items: [
      ...
      },
      {
        ...
        index: '/R02',
        kind: 'Blue Team',
        title: 'CVE Watch · Autonomous agent',
        summary:
          "Designed and built in full autonomy during an internship, with no technical support from the company on this topic: architecture, CVE matching, prioritization, and hardening of the bot itself. Code generated with Claude (AI) assistance, entirely directed and validated by me.",
        stack: ['Python', 'CVE API', 'Trivy', 'Self-taught'],
        status: 'Shipped',
        href: '/pdfs/veille-cyber.pdf',
      },
      {
